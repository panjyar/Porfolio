            ...
            {filteredProjects.map((project, index) => (
              ...
              >
                  ...
                  <div className="mt-4 bg-white rounded-lg p-4 border border-gray-200 min-h-[120px] flex items-center justify-center">
                    <div className="text-center text-gray-400">
                      <img
                        src={project.preview}
                        alt={project.name}
                        onClick={() => setPreviewImage(project.preview)}
                        className="cursor-pointer rounded-lg transition duration-300 hover:scale-105"
                      />
                      <p className="text-xs mt-2">Click to preview</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-6">
                  ...
                  {/* Action Buttons */}
                  <div className="flex gap-3 pb-2 border-t border-gray-100">
                    <Link
                    ...
                    <div className="mb-4 bg-blue-50 p-3 rounded-lg border border-blue-100">
                      <p className="text-xs text-gray-700">
                        <span className="font-semibold text-blue-700">
                          Used github actions CI/CD to automate deployment:
                        </span>{" "}
                        {project.deployment}
                      </p>
                    </div>
